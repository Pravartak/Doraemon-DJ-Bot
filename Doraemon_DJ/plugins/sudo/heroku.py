...
from Doraemon_DJ.misc import HAPP, SUDOERS, XCB
from Doraemon_DJ.utils.database import (get_active_chats,
                                       remove_active_chat,
                                       remove_active_video_chat)
from Doraemon_DJ.utils.decorators.language import language
from Doraemon_DJ.utils.pastebin import Dorabin
...
<u>ᑌՏᗩᘜᗴ:</u>
TOTᗩᒪ ᑌՏᗴᗪ: `{AppHours}`**ᕼ**  `{AppMinutes}`**ᗰ**  [`{AppPercentage}`**%**]

<u>ᖇᗴᗰᗩIᑎIᑎᘜ ᑫᑌOTᗩ:</u>
TOTᗩᒪ ᒪᗴᖴT: `{hours}`**ᕼ**  `{minutes}`**ᗰ**  [`{percentage}`**%**]"""
...
async def update_(client, message, _):
    ...
    if verification == "":
        return await response.edit("ᗷOT IՏ ᑌᑭ-TO ᗪᗩTᗴ!")
    updates = ""
    ...
    for info in repo.iter_commits(
        ...
        updates += f"<b>➣ #{info.count()}: [{info.summary}]({REPO_}/commit/{info}) by -> {info.author}</b>\n\t\t\t\t<b>➥ ᑕOᗰᗰITᗴᗪ Oᑎ:</b> {ordinal(int(datetime.fromtimestamp(info.committed_date).strftime('%d')))} {datetime.fromtimestamp(info.committed_date).strftime('%b')}, {datetime.fromtimestamp(info.committed_date).strftime('%Y')}\n\n"
    _update_response_ = "<b>ᗩ ᑎᗴᗯ ᑌᑭᗪᗩTᗴ IՏ ᗩᐯᗩIᒪᗩᗷᒪᗴ ᖴOᖇ Tᕼᗴ ᗷOT!</b>\n\n➣ ᑭᑌՏᕼIᑎᘜ ᑌᑭᗪᗩTᗴՏ ᑎOᗯ</code>\n\n**<u>ᑌᑭᗪᗩTᗴՏ:</u>**\n\n"
    _final_updates_ = _update_response_ + updates
    if len(_final_updates_) > 4096:
        url = await Dorabin(updates)
        nrs = await response.edit(
            f"<b>ᗩ ᑎᗴᗯ ᑌᑭᗪᗩTᗴ IՏ ᗩᐯᗩIᒪᗩᗷᒪᗴ ᖴOᖇ Tᕼᗴ ᗷOT!</b>\n\n➣ ᑭᑌՏᕼIᑎᘜ ᑌᑭᗪᗩTᗴՏ ᑎOᗯ</code>\n\n**<u>ᑌᑭᗪᗩTᗴՏ:</u>**\n\n[ᑕᒪIᑕK ᕼᗴᖇᗴ TO ᑕᕼᗴᑕKOᑌT ᑌᑭᗪᗩTᗴՏ]({url})"
        )
    else:
        nrs = await response.edit(
    ...
    if await is_heroku():
        try:
            ...
            for x in served_chats:
                try:
                    await app.send_message(
                        x,
                        f"{config.MUSIC_BOT_NAME} ᕼᗩՏ ᒍᑌՏT ՏTᗩᖇTᗴᗪ ᕼIᗰՏᗴᒪᖴ. ՏOᖇᖇY ᖴOᖇ Tᕼᗴ IՏՏᑌᗴՏ.\n\nՏTᗩᖇT ᑭᒪᗩYIᑎᘜ ᗩᖴTᗴᖇ 10 -15 ՏᗴᑕOᑎᗪՏ ᗩᘜᗩIᑎ.",
                    )
                    ...
                    pass
            await response.edit(
                f"{nrs.text}\n\nᗷOT ᗯᗩՏ ᑌᑭᗪᗩTᗴᗪ ՏᑌᑕᑕᗴՏՏᖴᑌᒪᒪY Oᑎ ᕼᗴᖇOKᑌ! ᑎOᗯ, ᗯᗩIT ᖴOᖇ 2 - 3 ᗰIᑎՏ ᑌᑎTIᒪ Tᕼᗴ ᗷOT ᖇᗴՏTᗩᖇTՏ!"
            )
            os.system(
            ...
            await response.edit(
                f"{nrs.text}\n\nՏOᗰᗴTᕼIᑎᘜ ᗯᗴᑎT ᗯᖇOᑎᘜ ᗯᕼIᒪᗴ IᑎITIᗩTIᑎᘜ ᖇᗴᗷOOT! ᑭᒪᗴᗩՏᗴ TᖇY ᗩᘜᗩIᑎ ᒪᗩTᗴᖇ Oᖇ ᑕᕼᗴᑕK ᒪOᘜՏ ᖴOᖇ ᗰOᖇᗴ IᑎᖴO."
            )
            return await app.send_message(
                config.LOG_GROUP_ID,
                f"ᗩᑎ ᗴ᙭ᗴᑭTIOᑎ Oᑕᑕᑌᖇᖇᗴᗪ ᗩT #ᑌᑭᗪᗩTᗴᖇ ᗪᑌᗴ TO: <code>{err}</code>",
            )
    else:
        served_chats = await get_active_chats()
        for x in served_chats:
            try:
                await app.send_message(
                    x,
                    f"{config.MUSIC_BOT_NAME} ᕼᗩՏ ᒍᑌՏT ᖇᗴՏTᗩᖇTᗴᗪ ᕼIᗰՏᗴᒪᖴ. ՏOᖇᖇY ᖴOᖇ Tᕼᗴ IՏՏᑌᗴՏ.\n\nՏTᗩᖇT ᑭᒪᗩYIᑎᘜ ᗩᖴTᗴᖇ 10-15 ՏᗴᑕOᑎᗪՏ ᗩᘜᗩIᑎ.",
                )
                await remove_active_chat(x)
                await remove_active_video_chat(x)
            except Exception:
                pass
        await response.edit(
            f"{nrs.text}\n\nᗷOT ᗯᗩՏ ᑌᑭᗪᗩTᗴᗪ ՏᑌᑕᑕᗴՏՏᖴᑌᒪᒪY! ᑎOᗯ, ᗯᗩIT ᖴOᖇ 1 - 2 ᗰIᑎՏ ᑌᑎTIᒪ Tᕼᗴ ᗷOT ᖇᗴᗷOOTՏ!"
        )
...
async def restart_(_, message):
    response = await message.reply_text("ᖇᗴՏTᗩᖇTIᑎᘜ...")
    served_chats = await get_active_chats()
    for x in served_chats:
        try:
            await app.send_message(
    ...
    try:
        ...
        pass
    await response.edit(
        "ᖇᗴᗷOOT ᕼᗩՏ ᗷᗴᗴᑎ IᑎITIᗩTᗴᗪ ՏᑌᑕᑕᗴՏՏᖴᑌᒪᒪY! ᗯᗩIT ᖴOᖇ 1 - 2 ᗰIᑎՏ ᑌᑎTIᒪ Tᕼᗴ ᗷOT ᖇᗴՏTᗩᖇTՏ."
    )
    os.system(f"kill -9 {os.getpid()} && bash start")
