...
from Doraemon_DJ.utils.database import add_sudo, remove_sudo
...
async def useradd(client, message: Message, _):
    if MONGO_DB_URI is None:
        return await message.reply_text(
            "**ᗪᑌᗴ TO ᗷOT'Տ ᑭᖇIᐯᗩᑕY IՏՏᑌᗴՏ, YOᑌ ᑕᗩᑎ'T ᗰᗩᑎᗩᘜᗴ ՏᑌᗪO ᑌՏᗴᖇՏ ᗯᕼᗴᑎ YOᑌ'ᖇᗴ ᑌՏIᑎᘜ ᗪOᖇᗩᗴᗰOᑎ'Տ ᗪᗩTᗩᗷᗩՏᗴ.\n\n ᑭᒪᗴᗩՏᗴ ᖴIᒪᒪ YOᑌᖇ MONGO_DB_URI Iᑎ YOᑌᖇ ᐯᗩᖇՏ TO ᑌՏᗴ TᕼIՏ ᖴᗴᗩTᑌᖇᗴ.**"
        )
    if not message.reply_to_message:
        ...
        if added:
            ...
            await message.reply_text("ᖴᗩIᒪᗴᗪ")
        return
...
async def userdel(client, message: Message, _):
    ...
    if removed:
        ...
        await message.reply_text(_["sudo_4"])
        return
    await message.reply_text(f"ՏOᗰᗴTᕼIᑎᘜ ᗯᗴᑎT ᗯᖇOᑎᘜ.")
