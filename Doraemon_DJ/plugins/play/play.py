...
from Doraemon_DJ import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from Doraemon_DJ.core.call import Dora
from Doraemon_DJ.utils import seconds_to_min, time_to_seconds
from Doraemon_DJ.utils.channelplay import get_channeplayCB
from Doraemon_DJ.utils.database import is_video_allowed
from Doraemon_DJ.utils.decorators.language import languageCB
from Doraemon_DJ.utils.decorators.play import PlayWrapper
from Doraemon_DJ.utils.formatters import formats
from Doraemon_DJ.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from Doraemon_DJ.utils.inline.playlist import botplaylist_markup
from Doraemon_DJ.utils.logger import play_logs
from Doraemon_DJ.utils.stream.stream import stream
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            if (
                ...
                return await mystic.edit_text(
                    "TᕼIՏ ᗷOT IՏᑎ'T ᗩᗷᒪᗴ TO ᑭᒪᗩY ՏᑭOTIᖴY ᑫᑌᗴᖇIᗴՏ. ᑭᒪᗴᗩՏᗴ ᗩՏK ᗰY Oᗯᑎᗴᖇ TO ᗴᑎᗩᗷᒪᗴ ՏᑭOTIᖴY."
                )
            if "track" in url:
                try:
            ...
            try:
                await Dora.stream_call(url)
            except NoActiveGroupCall:
                await mystic.edit_text(
                    "Tᕼᗴᖇᗴ'Տ ᗩᑎ IՏՏᑌᗴ ᗯITᕼ Tᕼᗴ ᗷOT. ᑭᒪᗴᗩՏᗴ ᖇᗴᑭOᖇT IT TO ᗰY Oᗯᑎᗴᖇ ᗩᑎᗪ ᗩՏK Tᕼᗴᗰ TO ᑕᕼᗴᑕK ᒪOᘜᘜᗴᖇ ᘜᖇOᑌᑭ."
                )
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    "ᑭᒪᗴᗩՏᗴ Tᑌᖇᑎ Oᑎ ᐯOIᑕᗴ ᑕᕼᗩT... ᗷOT IՏ ᑎOT ᗩᗷᒪᗴ TO ՏTᖇᗴᗩᗰ ᑌᖇᒪՏ...",
                )
            except Exception as e:
                return await mystic.edit_text(
...
async def anonymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
            "YOᑌ'ᖇᗴ ᗩᑎ ᗩᑎOᑎYᗰOᑌՏ ᗩᗪᗰIᑎ.\n\nᘜO TO YOᑌᖇ ᘜᖇOᑌᑭ'Տ ՏᗴTTIᑎᘜՏ \n-> ᗩᗪᗰIᑎIՏTᖇᗩTOᖇՏ ᒪIՏT \n-> ᑕᒪIᑕK Oᑎ YOᑌᖇ ᑎᗩᗰᗴ \n-> ᑌᑎᑕᕼᗴᑕK REMAIN ANONYMOUS ᗷᑌTTOᑎ Tᕼᗴᖇᗴ.",
            show_alert=True,
        )
    except:
        return
...
@app.on_callback_query(
    filters.regex("DoraPlaylists") & ~BANNED_USERS
)
@languageCB
