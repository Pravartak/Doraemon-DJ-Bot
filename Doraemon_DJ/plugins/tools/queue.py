...
from Doraemon_DJ.utils import (Dorabin, get_channeplayCB,
                              seconds_to_min)
from Doraemon_DJ.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from Doraemon_DJ.utils.decorators.language import language, languageCB
from Doraemon_DJ.utils.inline import queue_back_markup, queue_markup
...
async def ping_com(client, message: Message, _):
    ...
    if "live_" in file:
        ...
        if videoid == "telegram":
            ...
            IMAGE = get_image(videoid)
    send = (
        "**⌛️ᗪᑌᖇᗩTIOᑎ:** ᑌᑎKᑎOᗯᑎ ᗪᑌᖇᗩTIOᑎ ՏTᖇᗴᗩᗰ\n\nᑕᒪIᑕK Oᑎ ᗷᑌTTOᑎ ᗷᗴᒪOᗯ TO ᘜᗴT ᗯᕼOᒪᗴ ᑫᑌᗴᑌᗴᗪ ᒪIՏT."
        if DUR == "Unknown"
        else "\nᑕᒪIᑕK Oᑎ ᗷᑌTTOᑎ ᗷᗴᒪOᗯ TO ᘜᗴT ᗯᕼOᒪᗴ ᑫᑌᗴᑌᗴᗪ ᒪIՏT."
    )
    cap = f"""**{config.MUSIC_BOT_NAME} ᑭᒪᗩYᗴᖇ**
