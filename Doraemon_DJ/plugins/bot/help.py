...
from Doraemon_DJ.utils import help_pannel
from Doraemon_DJ.utils.database import get_lang, is_commanddelete_on
from Doraemon_DJ.utils.decorators.language import (LanguageStart,
                                                  languageCB)
from Doraemon_DJ.utils.inline.help import (help_back_markup,
                                          private_help_panel)
    ...
    if cb == "hb5":
        if CallbackQuery.from_user.id not in SUDOERS:
            return await CallbackQuery.answer(
                "TᕼIՏ IՏ ᑎOT ᖴOᖇ YOᑌ ᗷᖇᑌᕼᕼ! TᖇY ՏOᗰᗴTᕼIᑎᘜ ᗴᒪՏᗴ!", show_alert=True
            )
        else:
